...
if ($currentRemote -like "git@github.com:*") {
    ...
    git remote set-url origin https://github.com/FatemehGhorbani-fgh/aerial-human-detection.git
    ...
    git remote add origin https://github.com/FatemehGhorbani-fgh/aerial-human-detection.git
}
