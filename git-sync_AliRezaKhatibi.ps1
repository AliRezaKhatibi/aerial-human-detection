...
if ($currentRemote -like "git@github.com:*") {
    ...
    git remote set-url origin https://github.com/AliRezaKhatibi/aerial-human-detection.git
    ...
    git remote add origin https://github.com/AliRezaKhatibi/aerial-human-detection.git
}
